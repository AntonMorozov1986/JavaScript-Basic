...
//Запускаем первоначальное заполнение страницы
insertPostsWhenScrollBarIsDown();

//Событие прокрутки страницы
document.addEventListener('scroll', insertPostsWhenScrollBarIsDown);

/**
 * Функция вставляет несколько постов на страницу, когда скрол прокручен до конца.
 */
function insertPostsWhenScrollBarIsDown() {
...
function getPostMarkup() {
    /*
    * Генерируем случайное число для произвольного фото
    */
